...
namespace SwiftCode.BBS.EntityFramework.EFContext
{
    public class SwiftCodeBbsContext : DbContext
    {
        ...
        //{
        //    optionsBuilder.UseSqlServer(@"server=.;Database = SwiftCodeBbs;Trusted_connecton = true; Connection Timeout = 600;MultipleActiveResultSets = true;").LogTo(Console.WriteLine, LogLevel.Information);
        //}
