...
namespace SwiftCode.BBS.API.Controllers
{
    ...
    public class ArticleController : ControllerBase
    {
        ...
        public ArticleController(IArticleService articleServices, IBaseServices<UserInfo> userInfoService, IMapper mapper)
        {
        ...
        public async Task<MessageModel<List<ArticleDto>>> GetList(int page, int pageSize)
        {
            ...
            var entityList = await _articleServices.GetPageListAsync(page, pageSize, nameof(Article.CreateTime));
